...
public:
	...
	inline quat( real radians, const real3<real>& axis );
	inline quat( real radians1, const real3<real>& axis1, 
				 real radians2, const real3<real>& axis2, 
				 real radians3, const real3<real>& axis3 );

	// Getters
	inline void getRotation( real& radians, real& x, real& y, real& z ) const;
	inline void getRotation( real& radians, real3<real>& vec ) const;
	inline real* ptr();
	...
	inline void set( const real3<real>& v, real w );
	...
	inline void makeRotation( real radians, const real3<real>& vec );
	inline void makeRotation( real radians1, const real3<real>& axis1,
							  real radians2, const real3<real>& axis2,
							  real radians3, const real3<real>& axis3 );
	...
	inline void transform( real3<real>& v ) const;
...
template<typename real>
quat<real>::quat( real radians, const real3<real>& axis )
{
	makeRotation( radians, axis );
}

template<typename real>
quat<real>::quat( real radians1, const real3<real>& axis1,  
				  real radians2, const real3<real>& axis2,  
				  real radians3, const real3<real>& axis3 )
{
...
{
	void _RTU_quat_getRotation( const quat<real>& q, real& radians, real& x, real& y, real& z );
	_RTU_quat_getRotation( *this, radians, x, y, z );
}

template<typename real>
void quat<real>::getRotation( real& radians, real3<real>& vec ) const
{
...
template<typename real>
void quat<real>::set( const real3<real>& v, real w )
{
	_v[0] = v.x;
	_v[1] = v.y;
	_v[2] = v.z;
...
{
	return math<real>::isEqual( _v[0], 0 ) && 
		   math<real>::isEqual( _v[1], 0 ) && 
		   math<real>::isEqual( _v[2], 0 ) && 
		   math<real>::isEqual( _v[3], 1 );
}
...
{
	void _RTU_quat_makeRotation( quat<real>& q, real radians, real x, real y, real z );
	_RTU_quat_makeRotation( *this, radians, x, y, z );
}

template<typename real>
void quat<real>::makeRotation( real radians, const real3<real>& vec )
{
	makeRotation( radians, vec.x, vec.y, vec.z );
}

template<typename real>
void quat<real>::makeRotation( real radians1, const real3<real>& axis1,
							   real radians2, const real3<real>& axis2,
							   real radians3, const real3<real>& axis3 )
{
...
template<typename real>
void quat<real>::makeRotation( const real3<real>& from, const real3<real>& to )
{
	void _RTU_quat_makeRotation( quat<real>& q, const real3<real>& from, const real3<real>& to );
	_RTU_quat_makeRotation( *this, from, to );
}

template<typename real>
void quat<real>::slerp( real t, const quat<real>& from, const quat<real>& to )
{
	void _RTU_quat_slerp( quat<real>& q, real t, const quat<real>& from, const quat<real>& to );
	_RTU_quat_slerp( *this, t, from, to );
}

template<typename real>
void quat<real>::transform( real3<real>& v ) const
{
	// nVidia SDK implementation
	real3<real> uv, uuv;
	real3<real> qvec( _v[0], _v[1], _v[2] );
	uv = qvec.cross( v );
	uuv = qvec.cross( uv );
...
*/
class  quatd : public quat<double>
{
public:
	...
	inline quatd( double radians, const real3<double>& axis ) : quat<double>( radians, axis ) {;}

	//! Constructs a quaternion that matches the accumulated rotations of three angles around three axes.
	inline quatd( double radians1, const real3<double>& axis1, 
				  double radians2, const real3<double>& axis2, 
				  double radians3, const real3<double>& axis3 ) 
...
public:
	...
	//! Constructs a quaternion that matches the rotation of an angle (in 'radians') around an 'axis'.
	inline quatf( float radians, const real3<float>& axis ) : quat<float>( radians, axis ) {;}

	//! Constructs a quaternion that matches the accumulated rotations of three angles around three axes.
	inline quatf( float radians1, const real3<float>& axis1, 
				  float radians2, const real3<float>& axis2, 
				  float radians3, const real3<float>& axis3 ) 
